...
DEFAULT_LEVEL_VALUE = os.environ.get("DEFAULT_LEVEL_VALUE", "INFO")
# console
DEFAULT_CONSOLE_ENABLED_VALUE = os.environ.get("DEFAULT_CONSOLE_ENABLED_VALUE", "true").lower() == "true"
# file
DEFAULT_FILE_ENABLED_VALUE = os.environ.get("DEFAULT_FILE_ENABLED_VALUE", "false").lower() == "true"
DEFAULT_FILE_DIR_VALUE = os.environ.get("DEFAULT_FILE_DIR_VALUE", os.path.expanduser("~"))
DEFAULT_FILE_NAME_VALUE = os.environ.get("DEFAULT_FILE_NAME_VALUE", "dubbo.log")
